...
# ⚠️ Please don't change our credits 👇🏻
    ...
    ABOUT_TXT = """<b>✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/Mindsboss>Mɪɴᴅꜱ Bᴏꜱꜱ</a>
✯ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂: <a href=https://t.me/LusiFilms>LᴜꜱɪFɪʟᴍꜱ</a>
✯ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
✯ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙺𝙾𝚈𝙴𝙱
...
<b>COMMAND</b> : /font your text (optional)
 ...
 <i>This feature added by @Mindboss"""
    JSON_TXT = """<b>JSON:</b>
...
★ 𝙵𝚁𝙴𝙴 𝚂𝚃𝙾𝚁𝙰𝙶𝙴: <code>{}</code> 𝙼𝚒𝙱</b Bʏ @MLZ_BOTZ>"""
...
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ' : ( ! , . / )"""
    ...
    <code>[JOIN GROUP](buttonurl:https://t.me/Apnamovie4)</code>"""
...
⪼ 𝐄𝐱𝐚𝐦𝐩𝐥𝐞 ›
<code>/batch https://t.me/LusiFilms https://t.me/LusiFilms/code>
𝙲𝚁𝙴𝙳𝙸𝚃𝚂 ›› <a href=https://t.me/Mindsboss><b>𝗠𝗶𝗻𝗱𝘀𝗕𝗼𝘀𝘀</b></a>"""
